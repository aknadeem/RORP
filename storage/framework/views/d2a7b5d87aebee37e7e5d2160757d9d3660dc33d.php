        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="kt-portlet">
                    <div class="kt-portlet__head">
                        ...
                        <div class="kt-subheader__toolbar">
                            <div class="kt-subheader__wrapper">
                                <a href="<?php echo e(route('getCustomUser')); ?>"
                    ...
                    <!--begin::Form-->
                    <form class="kt-form"
                        action="<?php echo e(route('storeCustomUser')); ?>"
                        method="post">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                            ...
                                            <?php $__empty_1 = true; $__currentLoopData = $societies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $soc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                               <?php $__empty_2 = true; $__currentLoopData = $soc->sectors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sector): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                                                    <option value="<?php echo e($sector->id); ?>">
                                                        <?php echo e($sector->sector_name); ?> </option>
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/royal-app/resources/views/custom-user-data/create.blade.php ENDPATH**/ ?>