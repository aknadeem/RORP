        ...
        <div class="kt-subheader kt-grid__item" id="kt_subheader">
            <div class="kt-container kt-container--fluid">
                <div class="kt-subheader__main">
                    <h3 class="kt-subheader__title"><?php echo e(__('CustomUser')); ?> </h3>
                    <span class="kt-subheader__separator kt-subheader__separator--v"></span>
                    <a href="<?php echo e(route('getCustomUser')); ?>"><span class="kt-subheader__desc"><?php echo e(__('users')); ?></span></a>
                </div>
            </div>
        </div>
        <!-- end:: Content Head -->
                        ...
                        <div class="kt-portlet__head-wrapper">
                            <div class="kt-portlet__head-actions">
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create-user-management')): ?>
                                    <a href="<?php echo e(route('customUserForm')); ?>" class="btn btn-brand btn-elevate btn-sm btn-icon-sm"
                                       title="Create User">
                    ...
                    <table class="table table-striped table-hover table-checkable" id="kt_table_1">
                        ...
                        <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr>
                                ...
                                <td><a href="<?php echo e(route('custominvoice.create')); ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Add Invoice </a></td>
                                <td>
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update-user-management')): ?>
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/royal-app/resources/views/custom-user-data/index.blade.php ENDPATH**/ ?>