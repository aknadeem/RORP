    ...
    <div class="modal-dialog align-center" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form autocomplete="off" method="post" action="<?php echo e(route('designation.store')); ?>">
                    <?php echo csrf_field(); ?>
    ...
    $(function() {  
        $('.OpenaddTypeModal').click(function () {
            ...
            $('#TypeForm').on('submit', function(e) {
                e.preventDefault();
                let form_type = 'POST'
                let form_url = "<?php echo e(route('designation.store')); ?>"
                
                let naame = $('#DesignationName').val()
                let csrf_tok = "<?php echo e(csrf_token()); ?>"
                console.log(form_url);
                $.ajax({
                    type: form_type,
                    url:  form_url,
                  
                  data: {name: naame, _token: "<?php echo e(csrf_token()); ?>" },
                   cache: false,
...
<?php $__env->stopSection(); ?><?php /**PATH /var/www/royal-app/resources/views/_partial/add_types_modal.blade.php ENDPATH**/ ?>