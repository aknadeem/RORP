    ...
    <div class="kt-subheader kt-grid__item" id="kt_subheader">
        <div class="kt-container kt-container--fluid">
            <div class="kt-subheader__main">
                ...
                <a href="<?php echo e(route('users.index')); ?>"><span class="kt-subheader__desc"><?php echo e(__('Residents Users')); ?></span></a>
            </div>
        </div>
    </div>
    <!-- end:: Content Head -->
					...
					<div class="kt-portlet__head-wrapper">
						<div class="kt-portlet__head-actions">
							<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view-user-management')): ?>
								<a href="<?php echo e(route('users.index')); ?>" class="btn btn-brand btn-elevate btn-sm btn-icon-sm" title="Click to view users">
				...
				<table class="table table-striped table-hover table-checkable" id="kt_table_1">
					...
					<tbody>
                        ...
                        <?php endif; ?> 
								...
								<td> <a href="<?php echo e(($user->user_level_id < 6) ? route('users.show', $user->id) : $url); ?>" title="<?php echo e(($user->user_level_id < 6) ? $htitle : $title); ?>"> <?php echo e($user->name); ?> </a> </td>
								<td> <b> <?php echo e($user->society->name ?? ''); ?> </b> </td>
								<td>
									<?php if(count($user->permissions) > 0): ?>
										<a href="<?php echo e(route('user-permissions', $user->id)); ?>" title="view Permissions" class="btn btn-primary">
									...
									<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('assign-permission-user-management')): ?>
										<a href="<?php echo e(route('edituserpermissions', $user->id)); ?>" title="Add Permissions" class="btn btn-success">
								...
								<td>
	                                ...
	                                <a href="<?php echo e(route('user.toggleStatus',$user->id)); ?>" class="kt-switch kt-switch--outline kt-switch--icon kt-switch--success  confirm-status">
	                                ...
	                                <label class="kt-switch kt-switch--outline kt-switch--icon kt-switch--success" >
	                                    ...
	                                    <span  <?php echo e($user->is_active == 1 ? 'title=Deactive' : 'title=Active'); ?> class="slider <?php echo e($user->is_active == 1 ? '' : ''); ?>"></span>
	                                </label>
	                                </a>
	                                <?php else: ?>
								...
								<td>
									<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update-user-management')): ?>
	                                <a href="<?php echo e(route('users.edit', $user->id)); ?>" class="text-warning"> <i class="fa fa-edit fa-lg" title="Edit User"></i> </a> &nbsp;
	                                <?php endif; ?>
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/royal-app/resources/views/usermanagement/accountcreation/residents_accounts.blade.php ENDPATH**/ ?>