<div class="modal fade" id="AddPaymentModel" tabindex="-1" role="dialog" aria-labelledby="AddPaymentModel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form lass="loader" action="<?php echo e(route('fine.payment')); ?>" method="POST" id="PckgServiceModelForm">
                <?php echo csrf_field(); ?>
                ...
                <div class="modal-body">
                    <div class="form-group row">
                    	<div class="col-lg-12">
                            <label class="form-control-label"><b><?php echo e(__('Resident:')); ?></b></label>
                    ...
                    <div class="row">
	                    <div class="col-lg-6">
                            ...
                            <div class="input-group date">
								...
								?>
                                <input type="text" name="paid_date" required class=" kt_datepicker_validate form-control <?php $__errorArgs = ['payed_date'];
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($now_date); ?>" placeholder="Select date" style="border-radius: 3px;">
...
unset($__errorArgs, $__bag); ?>
						...
						<div class="col-lg-6">
                            ...
                            <div class="input-group date">
                                <input type="number" step="any" min="0" max="" required id="payed_amount" name="paid_amount" class="form-control <?php $__errorArgs = ['paid_amount'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
					...
					<div class="kt-widget kt-widget--user-profile-2">
						<div class="kt-widget__head pt-4">
							<div class="kt-widget__media">
								...
								<img class="kt-widget__img" src="<?php echo e(url('assets/media/users/default.jpg')); ?>" alt="image" style="border-radius: 20%;">
						...
						<div class="kt-widget__body">
							<div class="kt-widget__item">
								...
								<div class="kt-widget__contact">
									...
									<h5 class="kt-widget__data" id="FineAmount_D">Rs: <?php echo e(number_format($fine->fine_amount ?? 0, 0)); ?></h5>
								</div>
								<div class="kt-widget__contact">
							...
							<div class="kt-widget__section pt-0">
								<p id="FineDescription_D"><?php echo $fine->description ?? ''; ?></p>
							</div>
						</div>
					</div>
					<!--end::Widget -->
...
<?php $__env->stopSection(); ?><?php /**PATH /var/www/royal-app/resources/views/_partial/fine_pay_view_modal.blade.php ENDPATH**/ ?>