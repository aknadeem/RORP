              ...
              <tr>
                <td style="padding: 0 2.5em; text-align: center; padding-bottom: 1em;">
                  <div class="text">
                    ...
                    <h4>You are receiving this email because Your Service has been {{$service_status}} </h4>
                ...
                <td style="text-align: center;">
                  <div class="text-author">
                   {{--  <img src="images/person_2.jpg" alt="" style="width: 100px; max-width: 600px; height: auto; margin: auto; display: block;"> --}}
                    ...
                    <span class="position" style="border: 1px solid#c3bebe;padding: 7px 50px;">{{$service_status}} </span>
