    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="kt-portlet">
                <div class="kt-portlet__head">
                    <div class="kt-portlet__head-label">
                        <h3 class="kt-portlet__head-title">
                            {{ __(($sop->id > 0 ? "Edit" : "Create").' byLaw') }}
                        </h3>
                    </div>
                    <div class="kt-subheader__toolbar">
                        <div class="kt-subheader__wrapper">
                            <a href="{{ route('bylaws.index') }}" class="btn btn-brand btn-bold btn-sm kt-margin-l-10 mt-3">
                               {{ __('ByLaw')}}
                            </a>
                        </div>
                    </div>
                ...
                <!--begin::Form-->
                <form class="kt-form" action="{{ ($sop->id) ? route('bylaws.update', $sop->id ) : route('bylaws.store') }}" method="post">
                    @csrf
