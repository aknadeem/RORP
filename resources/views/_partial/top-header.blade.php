        ...
        <div id="kt_header_menu" class="kt-header-menu kt-header-menu-mobile kt-header-menu--layout-default">
            <ul class="kt-menu__nav">
                {{-- <li
                    ...
                    <a href="{{ route('create.notification') }}" class="kt-menu__link"><span
                            class="kt-menu__link-text">Create Notification</span><i
    ...
    <div class="kt-header__topbar">
        ...
        <div class="kt-header__topbar-item dropdown">
            <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="30px,0px" aria-expanded="true">
                ...
                <span class="kt-badge kt-badge--danger" style="margin-top: 10px; margin-left: -15px;">{{
                                ...
                                <a href="{{ $url }}" class="kt-notification__item">
                                    ...
                                    <div class="kt-notification__item-details">
                                        <div class="kt-notification__item-title">
                                            ...
                                            @elseif($notification->type == 'App\Notifications\ServiceNotification')
                                        ...
                                        <div class="kt-notification__item-time">
                                            By: <span class="text-info">{{ $notification->data['by'] ??
        ...
        <div class="kt-header__topbar-item kt-header__topbar-item--user">
            ...
            <div
                ...
                <div class="kt-notification">
                    <a href="{{ route('users.show', Auth::user()->id ) }}" class="kt-notification__item">
                        <div class="kt-notification__item-icon">
