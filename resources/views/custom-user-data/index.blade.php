        ...
        <div class="kt-subheader kt-grid__item" id="kt_subheader">
            <div class="kt-container kt-container--fluid">
                <div class="kt-subheader__main">
                    <h3 class="kt-subheader__title">{{ __('CustomUser')}} </h3>
                    <span class="kt-subheader__separator kt-subheader__separator--v"></span>
                    <a href="{{ route('getCustomUser') }}"><span class="kt-subheader__desc">{{ __('users')}}</span></a>
                </div>
            </div>
        </div>
        <!-- end:: Content Head -->
                        ...
                        <div class="kt-portlet__head-wrapper">
                            <div class="kt-portlet__head-actions">
                                @can('create-user-management')
                                    <a href="{{ route('customUserForm') }}" class="btn btn-brand btn-elevate btn-sm btn-icon-sm"
                                       title="Create User">
                    ...
                    <table class="table table-striped table-hover table-checkable" id="kt_table_1">
                        ...
                        @foreach ($users as $key=>$user)
                            ...
                            <tr>
                                ...
                                <td><a href="{{ route('custominvoice.create') }}" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Add Invoice </a></td>
                                <td>
                                    @can('update-user-management')
