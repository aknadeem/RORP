    ...
    <div class="kt-subheader kt-grid__item" id="kt_subheader">
        <div class="kt-container kt-container--fluid">
            <div class="kt-subheader__main">
                <a href="{{ route('invoice.index') }}" title="click to view total invoices">
                    <h3 class="kt-subheader__title">{{ __('Invoices')}}</h3>
                </a>
                <span class="kt-subheader__separator kt-subheader__separator--v"></span>
                <span class="kt-subheader__desc text-brand"> {{ucfirst($filter)}} Invoices</span>
            </div>
        </div>
    </div>
    @php
                ...
                <div class="form-group validated col-sm-5">
                    ...
                    <select class="form-control kt-selectpicker" name="search_user_id" data-live-search="true" required>
                        ...
                        <option {{ ($search_user_id == $user->id) ? 'selected' : '' }} value="{{$user->id}}">
                            {{ $user->name }}</option>
                        @empty
                        <option disabled value=""> No user Found </option>
                        @endforelse
                    </select>
                </div>
