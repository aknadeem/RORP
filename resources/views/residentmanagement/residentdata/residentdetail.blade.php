    ...
    <div class="kt-subheader kt-grid__item" id="kt_subheader">
        <div class="kt-container kt-container--fluid">
            <div class="kt-subheader__main">
                ...
                <a href="{{ route('users.index') }}"><span class="kt-subheader__desc">{{ __('Resident')}}</span></a>
                <span class="kt-subheader__separator kt-subheader__separator--v"></span>
                <span class="kt-subheader__desc">{{ __('detail') }}</span>
                        ...
                        <div class="kt-widget kt-widget--user-profile-1">
                            <div class="kt-widget__head">
                                <div class="kt-widget__media">
                                    ...
                                    <img src="{{ asset('storage/residents/'.$residentdata->image)}}" alt="image"
                                        style="border-radius: 10%;">
                                    @else
                                    <img src="{{url('assets/media/users/default.jpg?v=1')}}" alt="image"
                                        style="border-radius: 10%;">
                                    @endif
                                </div>
                            ...
                            <div class="kt-widget__body">
                                <div class="kt-widget__content" style="text-align: left !important;">
                                    <div class="kt-widget__info">
                                        ...
                                        <a href="#" class="kt-widget__data ">{{$residentdata->father_name ?? ''}}</a>
                                    </div>
                                    <div class="kt-widget__info">
                                        <span class="kt-widget__label">CNIC Number: </span>
                                        <a href="#" class="kt-widget__data ">{{$residentdata->cnic ?? ''}}</a>
                                    </div>
                                    <div class="kt-widget__info">
                                        <span class="kt-widget__label">Email:</span>
                                        <a href="#" class="kt-widget__data ">{{$residentdata->email ?? ''}}</a>
                                    </div>
                                    <div class="kt-widget__info">
                                        <span class="kt-widget__label">Phone:</span>
                                        <a href="#" class="kt-widget__data text-left">{{$residentdata->mobile_number ??
                                            '-'}}</a>
                                    </div>
                                    <div class="kt-widget__info">
                                        <span class="kt-widget__label">Society:</span>
                                        <span class="kt-widget__data"> {{$residentdata->society->name ?? ''}} </span>
                                    </div>
                                    <div class="kt-widget__info">
                                        <span class="kt-widget__label">Membership id:</span>
                                        <span class="kt-widget__data"><b>{{$residentdata->membership_id ??
                                                ''}}</b></span>
                                    </div>
                                </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-xl-6">
                                                    <input name="name" class="form-control" type="text" readonly
                                                        disabled value="{{$residentdata->name}}">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-xl-6">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" readonly disabled
                                                            name="contact_no" value="{{$residentdata->mobile_number}}"
                                                ...
                                                <div class="col-lg-9 col-xl-6">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" name="email" readonly
                                                            disabled value="{{$residentdata->email}}" readonly
...
@section('modal-popup')
@if ($residentdata !='')
@include('usermanagement.user.profile._viewResidentInfo', ['resident' => $residentdata])
@endif
@endsection
