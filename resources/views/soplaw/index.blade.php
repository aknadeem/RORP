				...
				<div class="kt-portlet__head-toolbar">
					<div class="kt-portlet__head-wrapper">
						<div class="kt-portlet__head-actions">
							@can('create-pages')
								<a href="{{ route('sops.create') }}" class="btn btn-brand btn-sm btn-elevate btn-icon-sm" title="Create Department"><i class="fa fa-plus mb-1"></i>{{ __('Create')}}</a>
							@endcan
						</div>
					</div>
				</div>
						...
						@forelse ($sops as $sop)
							<tr>
	                            ...
	                            <td>
									...
									@endcan
									@can('create-pages')
										<a href="{{route('sops.destroy', $sop->id)}}" class="text-danger delete-confirm" del_title="Sop {{$sop->title}}"><i class="fa fa-trash-alt fa-lg" title="{{ __('Delete Sop&Law') }}"></i></a>
									@endcan
								</td>                       
							</tr>
                        @empty
