        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="kt-portlet">
                    ...
                    <!--begin::Form-->
                    <form class="kt-form"
                        action="{{ ($userlevel->id) ? route('userlevels.update', $userlevel->id ) : route('userlevels.store') }}"
                        method="post">
                        @csrf
                        @if($userlevel->id)
                        @method('PUT')
                            ...
                            <div class="kt-section kt-section--first mb-0">
                                <div class="row">
                                    <div class="form-group validated col-sm-12">
                                        <label class="form-control-label" for="inputSuccess1"><b> {{ __('Title*:') }}
                                            </b> </label>

                                        <input type="text" class="form-control @error('title') is-invalid @enderror"
                                            name="title" value="{{ $userlevel->title ?? old('title') }}" required
                                            autocomplete="title" autofocus
                                            placeholder="{{ __('Enter User Level Title') }}">
                                        @error('title')
                                            ...
                                            <th> {{ __('Permissions')}}
                                                <button type="button" class="btn btn-bold btn-label-brand btn-sm"
                                                    ...
                                                    data-target="#kt_modal_1" style="float: right;"><i
                                                        class="fa fa-plus mb-1"></i>{{ __('Create
                                                    Permission')}}</button>
                                        ...
                                        <tr class="permissionBoxes">
                                            ...
                                            <td>
                                                ...
                                                <label class="kt-checkbox kt-checkbox--bold kt-checkbox--success mt-2"
                                                    id="{{$module}}">
                                                    <input type="checkbox" value="{{$perm->id}}" {{ (in_array($perm->id,
                                                    old('permissions', [])) ||
                                                    $userlevel->permissions->contains($perm->id)) ? 'checked' : '' }}
                                                    name="permissions[]"> {{$perm->title}}
                                                    <span></span>
                                                </label> &nbsp; &nbsp;
                                                @endforeach
                                            </td>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="form-group validated col-sm-12">
                            ...
                            <select class="form-control kt-select2 @error('module_id') is-invalid @enderror"
                    ...
                    <div class="row">
                        <div class="form-group validated col-sm-12">
                            ...
                            <input type="text" class="form-control @error('title') is-invalid @enderror" name="title"
                                value="{{ $permission->title ?? old('title') }}" required autocomplete="name" autofocus
