						...
						<div class="kt-widget kt-widget--user-profile-1">
							<div class="kt-widget__head">
								<div class="kt-widget__media">
									@if ($user->user_image !='')
									<img src="{{url('uploads/userprofile/'.$user->user_image)}}" alt="image"
								...
								<div class="kt-widget__content">
									<div class="kt-widget__section">
										<a href="#" class="kt-widget__username">
											...
											<i title="Status: {{$user->status_type}}"
												class="flaticon2-correct kt-font-success "></i>
											@else
											<i title="Status: {{$user->status_type}}"
												class="flaticon2-warning kt-font-warning "></i>
							...
							<div class="kt-widget__body">
								...
								<div class="kt-widget__items">
									...
									@if (auth()->user()->id == $user->id OR auth()->user()->user_level_id < 3) <a
										href="{{ route('changePasswordView',$user->id) }}" class="kt-widget__item ">
										<span class="kt-widget__section">
											<span class="kt-widget__icon">
												<svg xmlns="http://www.w3.org/2000/svg"
													xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
										...
										<a href="{{ route('admin.getsocieties',$user->id) }}"
											class="kt-widget__item kt-widget__item">
											<span class="kt-widget__section">
												<span class="kt-widget__icon">
													<svg xmlns="http://www.w3.org/2000/svg"
														xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
												...
												<div class="col-lg-9 col-xl-6">
													<div class="input-group">
														...
														<input type="text" class="form-control" name="email" readonly
															disabled value="{{$user->email}}" readonly
											...
											<div class="form-group row">
												...
												<div class="col-lg-9 col-xl-6">
													<input name="address" class="form-control" type="text" readonly
														disabled placeholder="Enter Address" value="{{$user->address}}">
												</div>
											</div>
										</div>
									</div>
