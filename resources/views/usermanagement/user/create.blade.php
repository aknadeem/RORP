        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="kt-portlet">
                    <div class="kt-portlet__head">
                        <div class="kt-portlet__head-label">
                            ...
                            <h3 class="kt-portlet__head-title">
                                {{ __(($user->id > 0 ? "Edit" : "Create").' User') }}
                            <small> i.e SuperAdmin, Admin , HOD, Assistent Manager, Supervisor</small> </h3>    
                            {{-- @endcan --}}
                    ...
                    <!--begin::Form-->
                    <form class="kt-form" action="{{ ($user->id) ? route('users.update', $user->id ) : route('users.store') }}" method="post">
                        @csrf
                        @php
                        $exLevel = 0;
                            ...
                            <div class="kt-section kt-section--first mb-0">
                            	<div class="row">
                                    ...
                                    <div class="form-group validated col-sm-6">
                                        ...
                                        <input type="text" name="cnic" class="form-control kt_inputmask_cnic @error('cnic') is-invalid @enderror" value="{{ $user->cnic ?? old('cnic') }}" placeholder="00000-0000000-0">
                                        @error('cnic')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group validated col-sm-6">
                                        ...
                                        <input type="password" name="password" class="form-control @error('password') is-invalid @enderror" placeholder="{{ __('Enter Password') }}">
                                        @error('password')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group validated col-sm-6">
                                        ...
                                        <input type="text" name="contact_no" value="{{ $user->contact_no ?? old('contact_no') }}"  class="form-control kt_inputmask_8_1 @error('contact_no') is-invalid @enderror" required placeholder="{{ __('Enter Contact Number') }}">
                                        @error('contact_no')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group validated col-sm-6">
                                        ...
                                        <select class="form-control kt-selectpicker @error('society_id') is-invalid @enderror" name="society_id" data-live-search="true" id="societySelect">
                                                <option selected disabled>  {{ __('Select Society')}}</option>
                                                @forelse($societies as $soc)
                                                    <option {{ ($exSoc  == $soc->id) ? 'selected' : '' }} value="{{$soc->id}}"> {{$soc->name}} </option> 
                                                @empty
                                   ...
                                   {{--  <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <select class="form-control kt-selectpicker @error('society_sector_id') is-invalid @enderror" name="society_sector_id" data-live-search="true" id="sectorSelect">
                                                    <option selected disabled>  {{ __('Select Sector')}}</option>

                                                    @if ($exSector > 0 ?? '')
                                                        <option selected value="{{$exSector}}">{{ $user->sector->sector_name }}</option>
                                                    @endif
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <select class="form-control kt-selectpicker @error('user_level_id') is-invalid @enderror" name="user_level_id" data-live-search="true" required>
