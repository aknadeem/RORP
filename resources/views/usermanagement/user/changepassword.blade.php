						...
						<div class="kt-widget kt-widget--user-profile-1">
							...
							<div class="kt-widget__body">
								...
								<div class="kt-widget__items">
									...
									<a href="{{ route('changePasswordView',$user->id) }}" class="kt-widget__item kt-widget__item--active ">
										<span class="kt-widget__section">
											<span class="kt-widget__icon">
												<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
													<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="kt-portlet">
                            ...
                            <form action="{{ route('changePasswordUpdate') }}" method="POST" enctype="multipart/form-data" class="kt-form">
                                @csrf
                                    ...
                                    <div class="kt-form__actions">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-9 col-xl-9">
                                                <button type="submit" class="btn btn-brand btn-sm">Change Password</button>&nbsp;
